...
# Parameters
dir1="/Net/gleam/tkelly/MITGCM/verification/gom_test_sim/input/flow_fields"
dir2="/Net/gleam/tkelly/MITGCM/verification/gom_test_sim/input/input_off"
field_freq=86400
physical_dt=3600
...
/bin/rm -rf $dir2
/bin/mkdir $dir2
/bin/mkdir ${dir2}/tmp ${dir2}/sal ${dir2}/uvel ${dir2}/vvel ${dir2}/wvel
